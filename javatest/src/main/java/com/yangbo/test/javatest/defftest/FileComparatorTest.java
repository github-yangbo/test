package com.yangbo.test.javatest.defftest;
...
public class FileComparatorTest {
    ...
    private final File original = new File("D:/test/javatest/originalFile.txt");
 
    private final File revised = new File("D:/test/javatest/revisedFile.txt");
    
    public static void main(String[] args) {
    	FileComparatorTest t = new FileComparatorTest();
    	t.shouldGetChangesBetweenFiles();
//    	t.shouldGetInsertsBetweenFiles();
//    	t.shouldGetDeletesBetweenFiles();
	}
...
//    @Test
    public void shouldGetChangesBetweenFiles() {
        ...
        try {
        	...
        	System.out.println("Error running test shouldGetChangesBetweenFiles " + ioe.toString());
        }
    }
...
//    @Test
    public void shouldGetInsertsBetweenFiles() {
        ...
        try {
        	...
        	System.out.println("Error running test shouldGetInsertsBetweenFiles " + ioe.toString());
        }
    }
...
//    @Test
    public void shouldGetDeletesBetweenFiles() {
        ...
        try {
        	...
        	System.out.println("Error running test shouldGetDeletesBetweenFiles " + ioe.toString());
        }
    }
